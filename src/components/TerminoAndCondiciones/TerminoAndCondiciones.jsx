...
import style from "./TerminoAndCondiciones.module.css";


const TerminoAndCondiciones = ({close}) => {
...
<div className={style.description}>
  ...
  <strog> TÉRMINOS DEL SERVICIO</strog><br/>

----<br/>

GENERALIDADES<br/>

psiconnect gestiona este sitio web. En todo el sitio, los términos "nosotros", "nos" y "nuestro" se refieren en lo sucesivo a psiconnect. psiconnect  es un servicio de atención psicológica online que permite conectarte con profesionales altamente calificados desde la comodidad de tu casa, brindándote acompañamiento y soporte para afrontar los problemas del día a día.
Las horas reservadas por los cliente pueden ser cambiadas sin tener que volver a cancelar la tarifa con un mínimo de 48 horas de anticipacion de dicha hora reservada de lo contrario perderá el monto cancelado.
...
Los presentes Términos del servicio y cualquier acuerdo por separado por el cual le proporcionemos Servicios se regirán e interpretarán de acuerdo con las leyes de C, Argentina.
...
Las preguntas sobre los Términos del servicio se deben enviar a salud.psiconnect@gmail.com.

  </p>
  <button className={style.boton} onClick={close}>Aceptar</button>
</div>
</div>

)}
export default TerminoAndCondiciones;